...
public class TransferRequestEncoder extends Encoder
{
    @Override
    public ByteBuf encode(Packet packet)
    {
        if (!(packet instanceof TransferRequestPacket requestPacket)) {
            throw new IllegalArgumentException("Packet type mismatch; packet must be of type TransferRequestPacket");
        }
